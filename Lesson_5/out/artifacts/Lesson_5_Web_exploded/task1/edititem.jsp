...
%>
<form action="/editstudent?id=<%= student.getId() %>" method="post" class="container-fluid">
    <table class="table table-borderless">
        ...
        <tr>
            <td style="text-align: left">
                <button class="btn btn-primary"><a href="/detailsitem?id=<%= student.getId() %>" class="nav-link">BACK</a></button>
            </td>
